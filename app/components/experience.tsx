...
const roles: Role[] = [
  {
    ...
    bullets: [
      ...
      "I defined and delivered the product vision for a self service API platform. I launched an API marketplace and producer and consumer journeys that cut API creation lead time from six or more days to under two hours and increased API reuse fourfold.",
      "I translated business and security needs into a generative AI based threat assessment capability that automated risk surfacing and scoring, delivering multimillion dollar savings each year.",
      "I built an AI driven API inventory from CI/CD metadata, repository intelligence, logs, and telemetry to automate compliance reporting and ownership mapping across tens of thousands of services.",
      "I embedded OWASP aligned policy controls and risk scoring into CI/CD developer workflows to achieve audit ready delivery without slowing velocity. I own intake, governance, and sequencing across ten global teams on Apigee Hybrid.",
    ],
  },
  {
    ...
    bullets: [
      ...
      "I reduced release risk and improved throughput by operationalizing scaled Agile practices, including PI planning, Scrum of Scrums, and dependency mapping. I drove roadmap decisions through an executive portfolio insights engine built on Jira and Tableau.",
    ],
  },
  {
    title: "Scrum Master",
    ...
    bullets: [
      ...
      "I enforced HIPAA, HITRUST, and SOX controls across Teradata, Oracle, SQL Server, and Hadoop while leading two Agile teams in SAFe with two week sprints.",
    ],
  },
  {
